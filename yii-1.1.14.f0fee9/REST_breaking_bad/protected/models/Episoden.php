 ...
 * @property string $DEUTSCH­SPRACHIGE_ERSTAUS­STRAHLUNG­_D
...
class Episoden extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('NR_TOTAL, NR_STAFFEL, DEUTSCHER_TITEL, ORIGINAL­TITEL, ERSTAUS­STRAHLUNG_USA, REGIE, DREHBUCH, INHALT', 'required'),
			array('NR_TOTAL, NR_STAFFEL', 'numerical', 'integerOnly'=>true),
			array('DEUTSCHER_TITEL, ORIGINAL­TITEL, ERSTAUS­STRAHLUNG_USA, DEUTSCH­SPRACHIGE_ERSTAUS­STRAHLUNG­_D, REGIE, DREHBUCH, US_QUOTEN', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('NR_TOTAL, NR_STAFFEL, DEUTSCHER_TITEL, ORIGINAL­TITEL, ERSTAUS­STRAHLUNG_USA, DEUTSCH­SPRACHIGE_ERSTAUS­STRAHLUNG­_D, REGIE, DREHBUCH, US_QUOTEN, INHALT', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'DEUTSCH­SPRACHIGE_ERSTAUS­STRAHLUNG­_D' => 'Deutsch­ Sprachige Erstaus­ Strahlung­ D',
			'REGIE' => 'Regie',
			'DREHBUCH' => 'Drehbuch',
			'US_QUOTEN' => 'Us Quoten',
			'INHALT' => 'Inhalt',
	...
	public function search()
	{
		...
		$criteria->compare('DEUTSCH­SPRACHIGE_ERSTAUS­STRAHLUNG­_D',$this->DEUTSCH­SPRACHIGE_ERSTAUS­STRAHLUNG­_D,true);
